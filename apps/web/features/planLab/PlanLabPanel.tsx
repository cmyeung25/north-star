...
export default function PlanLabPanel({
  ...
  useEffect(() => {
    if (deepLink.openPanel) {
      setPanelValue("plan-lab");
      setGoalType("family-launch");
    }
  }, [deepLink.openPanel, setGoalType, setPanelValue]);
            ...
            <Stack gap="lg">
                        ...
                        {familyHousingMode === "buy-home" && (
                          <SimpleGrid cols={{ base: 1, md: 2 }} spacing="sm">
                            ...
                            <NumberInput
                              ...
                              min={0}
                              onChange={(value) =>
                                setFamilyHomePrice(typeof value === "number" ? value : "")
                              }
                            />
                            <NumberInput
                              ...
                              onChange={(value) => {
                                ...
                                if (typeof amount === "number" && typeof familyHomePrice === "number") {
                                  setFamilyDownPaymentPct(
                                    familyHomePrice > 0
                                      ? Number(((amount / familyHomePrice) * 100).toFixed(2))
                                      : 0
                                  );
                                }
                              }}
                            ...
                            <NumberInput
                              ...
                              onChange={(value) => {
                                ...
                                if (typeof pct === "number" && typeof familyHomePrice === "number") {
                            ...
                            <NumberInput
                              ...
                              min={0}
                              onChange={(value) =>
                                setFamilyOneOffFees(typeof value === "number" ? value : "")
                              }
                            />
                            <NumberInput
                              ...
                              min={0}
                              onChange={(value) =>
                                setFamilyHoldingCost(typeof value === "number" ? value : "")
                              }
                            />
                            <NumberInput
              ...
              {goalType === "family-launch" && (
                <>
                  ...
                  <Stack gap="sm">
                    <Group justify="space-between" align="center" wrap="wrap">
                      <Text fw={600}>{t("planLabFamilyExperimentsTitle")}</Text>
                      <Button
                        size="xs"
                        variant="light"
                        onClick={() => applyFamilyDraft(deepLink.familyLaunchDraft)}
                      >
                        {t("planLabFamilyExperimentsReset")}
                      </Button>
                    </Group>
                    {applicableExperiments.length === 0 && (
                      <Text size="sm" c="dimmed">
                        {t("planLabFamilyExperimentsEmpty")}
                      </Text>
                    )}
                    <Group gap="xs" wrap="wrap">
                      {applicableExperiments.map((experiment) => (
                        <Button
                          key={experiment.id}
                          size="xs"
                          variant="light"
