...
const translations = {
  "zh-HK": {
    ...
    eventFormCancel: "取消",
    eventFormSave: "儲存",
    homeDetailsTitle: "物業詳情",
    homeDetailsAddHome: "新增物業",
    homeDetailsRemoveHome: "移除物業",
    homeDetailsHomeLabel: "物業 #{index}",
    homeDetailsEmpty: "尚未新增物業。",
    homeDetailsUsage: "用途",
    homeDetailsUsagePrimary: "自住",
    homeDetailsUsageInvestment: "投資",
    homeDetailsMode: "模式",
    homeDetailsModeNewPurchase: "新購",
    homeDetailsModeExisting: "已擁有",
    homeDetailsPurchaseMonth: "購入月份",
    homeDetailsPurchasePrice: "購入價格",
    homeDetailsDownPayment: "首期金額",
    homeDetailsMortgageRate: "按揭利率 %",
    ...
    homeDetailsExistingAsOfMonth: "現況月份",
    homeDetailsExistingMarketValue: "市值",
    homeDetailsExistingMortgageBalance: "按揭餘額",
    homeDetailsExistingRemainingTerm: "剩餘期數 (月)",
    homeDetailsExistingMortgageRate: "按揭利率 %",
    homeDetailsRentalEnabled: "出租物業",
    homeDetailsRentalMonthly: "每月租金",
    homeDetailsRentalStart: "出租開始月份",
    homeDetailsRentalEnd: "出租結束月份",
    homeDetailsRentalGrowth: "租金年度增長 %",
    homeDetailsRentalVacancy: "空置率 %",
