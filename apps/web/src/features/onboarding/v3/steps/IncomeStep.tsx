...
export default function IncomeStep({ rows, onOverrideAmount }: Props) {
  return (
    <Stack>
      <Text size="sm">Auto-generated incomes from property rules. Editable fields can be overridden.</Text>
      <Table>
        <Table.Thead>
